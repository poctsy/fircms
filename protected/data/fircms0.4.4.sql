...
(410, 2, 7, 2, '新闻资讯', 'upload/thumb/20131108/20131108163321_47304.png', '', '', '', 'list', 'news', '新闻资讯', '0', '0', ''),
(411, 8, 15, 2, '产品展示', '', '', '', '', 'list', 'product', ' ', '0', '0', ''),
(415, 3, 4, 3, '公司动态', '', '', '', '', 'list', 'classa', '', '0', '0', ''),
(416, 5, 6, 3, '业界资讯', '', '', '', '', 'list', 'classb', '', '0', '0', ''),
(420, 9, 14, 3, '饰品珠宝', '', '', '', '', 'list', 'a2', '', '0', '0', ''),
(421, 10, 11, 4, '最新款', '', '', '', '', 'list', 'a3', '', '0', '0', ''),
(427, 16, 21, 2, '下载中心', '', '', '', '', 'list', 'download', '', '0', '0', ''),
(428, 12, 13, 4, '经典款', '', '', '', '', 'list', 'a4', '', '0', '0', ''),
(429, 17, 18, 3, '图册下载', '', '', '', '', 'list', 'a5', '', '0', '0', ''),
...
INSERT INTO `fircms_post` (`id`, `catalog_id`, `title`, `title_s`, `keyword`, `thumb`, `description`, `user_id`, `view_count`, `create_time`, `content`, `images`, `file`) VALUES
(1, 415, '测试', '', '测试关键字', 'upload/thumb/20131108/20131108145527_56244.jpg', '测试测试', 0, 0, 0, '测试<span style="color:#555555;font-family:Arial, Helvetica, sans-serif;font-weight:bold;line-height:normal;background-color:#FFFFFF;">内容</span>', '{img}{src}upload/image/20131108/20131108145632_79988.jpg{/src}{text}测试{/text}{/img}', 'upload/file/20131108/20131108145511_85893.rar');
...
(1, 'fircms', '550e35731605e382ece7229bf526e3cc', 'TUhGDB&,7-okBSM0y!ql1j]C+=w)RQqQ', 'webmaster@example.com', 1380376428, 1383888487, 1383906431, '127.0.0.1', '127.0.0.1', '', '', '', '', '', 0, 0, ''),
