...
(411, 14, 21, 2, '产品展示', 'upload/thumb/20131110/20131110000909_61240.png', '', '', '', 'list', 'product', ' ', '0', '0', ''),
...
(420, 15, 20, 3, '饰品珠宝', '', '', '', '', 'list', 'a2', '', '0', '0', ''),
(421, 16, 17, 4, '最新款', '', '', '', '', 'list', 'a3', '', '0', '0', ''),
(427, 8, 13, 2, '下载中心', '', '', '', '', 'list', 'download', '', '0', '0', ''),
(428, 18, 19, 4, '经典款', '', '', '', '', 'list', 'a4', '', '0', '0', ''),
(429, 9, 10, 3, '图册下载', 'upload/thumb/20131109/20131109135637_11955.png', '', '', '', 'list', 'a5', '', '0', '0', ''),
(430, 11, 12, 3, '文档下载', '', '', '', '', 'list', 'a6', '', '0', '0', '');
...
INSERT INTO `fircms_navigation` (`id`, `root`, `lft`, `rgt`, `name`, `level`, `catalog_id`, `page_id`, `link`, `module`, `position`, `bind_type`) VALUES
(401, 401, 1, 6, '导航条1', 1, 0, 0, '', '', 'top_1', 0),
(407, 401, 2, 3, 'aa', 2, 410, 1, '', 'message', '', 0),
(408, 401, 4, 5, '11', 2, 410, 1, '', 'message', '', 0);
...
INSERT INTO `fircms_page` (`id`, `thumb`, `title`, `title_s`, `keyword`, `description`, `url`, `content`, `view`) VALUES
(1, NULL, '关于我们', '', '', '', 'aaa', '', '0');
...
(1, 'fircms', '550e35731605e382ece7229bf526e3cc', 'TUhGDB&,7-okBSM0y!ql1j]C+=w)RQqQ', 'webmaster@example.com', 1380376428, 1384010921, 1384012328, '127.0.0.1', '127.0.0.1', '', '', '', '', '', 0, 0, ''),
