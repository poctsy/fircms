...
INSERT INTO `fircms_catalog` (`id`, `lft`, `rgt`, `level`, `name`, `thumb`, `title`, `keyword`, `description`, `plugin_id`, `url`, `content`, `first_view`, `second_view`) VALUES
...
(6, '单页模块', 'page', 3, 'post_', '', 'page'),
(7, '封面模块', 'cover', 2, 'cover_', '', 'cover'),
(9, '链接模块', 'link', 4, '', '', 'page');
